...
class TestNode : public rclcpp::Node {
 ...
 private:
  ...
  // ==================== 新添加的服务处理函数 ====================
  void handleHitArmor(const std::shared_ptr<referee_pkg::srv::HitArmor::Request> request,
  ...
  // ==================== 新添加的计算装甲板中心点函数 ====================
  geometry_msgs::msg::Point calculateArmorCenter(const std::vector<geometry_msgs::msg::Point>& model_points);
  // ========================================================
...
void TestNode::handleHitArmor(const std::shared_ptr<referee_pkg::srv::HitArmor::Request> request,
    ...
    try {
        ...
        RCLCPP_INFO(this->get_logger(), 
                   "Armor Center: (%.3f, %.3f, %.3f)", 
                   armor_center.x, armor_center.y, armor_center.z);
        RCLCPP_INFO(this->get_logger(), 
                   "Hit Point: (%.3f, %.3f, %.3f)", 
